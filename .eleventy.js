...
module.exports = function(eleventyConfig) {
    ...
    eleventyConfig.addFilter("markdownify", x => { return md.render(x); } );
    ...
    ['js', 'css', 'font', 'kuvat',
     'robots.txt', '*.png', '*.pdf', 'BingSiteAuth.xml', 'CNAME',
     'seiskat/kuvake', 'seiskat/manifest.json',
     'BW2006', 'BW2016',
    ...
    // want to do **/*.pdf, **/*.png but they hit _site recursively
